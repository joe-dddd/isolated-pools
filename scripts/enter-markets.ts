...
async function main() {
  ...
  const vWBNBAddr = "0x6Fa7E56CCD53f17BF0FeA173756B3766Eb4EEA97";
  ...
  // Enter markets - vWBNB has 75% collateral factor
  const marketsToEnter = [vWBNBAddr, vMockUSDTAddr, vMockTKNAddr];
  console.log("\nEntering markets:");
  console.log("  - vWBNB:", vWBNBAddr, "(75% collateral factor)");
